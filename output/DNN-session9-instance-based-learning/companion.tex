...
\begin{description}[leftmargin=8.5em,style=nextline,font=\normalfont\bfseries\color{navy}]
  \item[Lazy Learning] Storing training instances without explicit model training until prediction time.
  \item[k-Nearest Neighbors] A non-parametric method classifying/regressing based on $k$ closest training points.
\end{description}
\end{document}
