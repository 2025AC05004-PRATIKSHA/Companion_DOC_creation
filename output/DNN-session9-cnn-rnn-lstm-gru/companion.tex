...
\begin{steps}
  \item \textbf{Step 1: Reset Gate $r_1$.}
        $$W_r x_1 + U_r h_0 + b_r = \begin{bmatrix} 0.4 \\ 0.3 \end{bmatrix} + \begin{bmatrix} 0.34 \\ 0.24 \end{bmatrix} + \begin{bmatrix} 0.1 \\ 0.1 \end{bmatrix} = \begin{bmatrix} 0.84 \\ 0.64 \end{bmatrix} \implies r_1 = \sigma\begin{bmatrix} 0.84 \\ 0.64 \end{bmatrix} = \begin{bmatrix} 0.6985 \\ 0.6547 \end{bmatrix}.$$
  \item \textbf{Step 2: Update Gate $z_1$.}
        $$W_z x_1 + U_z h_0 + b_z = \begin{bmatrix} 0.45 \\ 0.45 \end{bmatrix} + \begin{bmatrix} 0.22 \\ 0.26 \end{bmatrix} + \begin{bmatrix} 0.2 \\ 0.2 \end{bmatrix} = \begin{bmatrix} 0.87 \\ 0.91 \end{bmatrix} \implies z_1 = \sigma\begin{bmatrix} 0.87 \\ 0.91 \end{bmatrix} = \begin{bmatrix} 0.7047 \\ 0.7130 \end{bmatrix}.$$
  ...
  \item \textbf{Step 5: Final Hidden State Update $h_1$.}
        $$h_1 = z_1 \odot h_0 + (1 - z_1) \odot \tilde{h}_1 = \begin{bmatrix} 0.7047(0.6) + (0.2953)(0.7487) \\ 0.7130(0.4) + (0.2870)(0.5516) \end{bmatrix} = \begin{bmatrix} 0.4228 + 0.2211 \\ 0.2852 + 0.1583 \end{bmatrix} = \begin{bmatrix} 0.6439 \\ 0.4435 \end{bmatrix}.$$
\end{steps}
\end{worked}
...
$$\text{Recurrent Params} = 3 \times (256 \times 100 + 256^2 + 256) = 3 \times (25,600 + 65,536 + 256) = 274,176 \approx 274\text{K}.$$
\end{worked}
...
For $d=100, h=256, V=10,000$:
$$\text{Recurrent Params} = 4 \times (256 \times 100 + 256^2 + 256) = 4 \times (25,600 + 65,536 + 256) = 365,568 \approx 366\text{K}.$$
\end{worked}
